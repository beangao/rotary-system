...
import { Lock, AlertTriangle, ChevronLeft, Check, Eye, EyeOff } from 'lucide-react-native';
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setErrors({ password: response.error || 'パスワードの再設定に失敗しました' });
      }
    } catch (err: any) {
      const message = err.response?.data?.error || 'パスワードの再設定に失敗しました';
    ...
    return (
      <SafeAreaView style={styles.container} edges={['bottom']}>
        <View style={[styles.successContent, { paddingTop: insets.top }]}>
          ...
          <Text style={styles.successTitle}>パスワードを再設定しました</Text>
          ...
          >
            <Text style={styles.successButtonText}>ログイン画面へ</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    );
  ...
  return (
    <SafeAreaView style={styles.container} edges={['bottom']}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
        ...
        <Text style={styles.headerTitle}>パスワード再設定</Text>
        ...
        >
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoContent}>
              <Text style={styles.infoTitle}>新しいパスワードを設定</Text>
              <Text style={styles.infoDescription}>
                ログインに使用する新しいパスワードを設定してください。
              </Text>
            </View>
          </View>
          ...
          <View style={styles.emailCard}>
            <Text style={styles.emailLabel}>対象アカウント</Text>
        ...
        <View style={styles.footer}>
          ...
          >
            {isLoading ? (
              ...
              <Text style={styles.submitButtonText}>パスワードを再設定</Text>
            )}
          </TouchableOpacity>
        </View>
      </KeyboardAvoidingView>
